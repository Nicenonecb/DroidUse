...
2026-09-24 新增 `RoutingDroidUsePlatform` 和 `CallDroidUsePlatform`，通过独立 ROM 组件连接 Telecom/通话音频。需配套 `platform/rom/telecom`、新合同及 Executor；尚未集成整机或实机验收，详见 [M4 后端](../../../docs/m4-rom-call-backend.md)。
